...
struct Fitter3DLevyFull : public Fitter3D<Fitter3DLevyFull> {
  ...
  setup_minuit(TMinuit &minuit) const override
  {
    ...
    minuit.mnparm(ALPHAOUT_PARAM_IDX, "AlphaOut", 1.0, 0.1, 0.5, 5.0, errflag);
    minuit.mnparm(ALPHASIDE_PARAM_IDX, "AlphaSide", 1.0, 0.1, 0.5, 5.0, errflag);
    minuit.mnparm(ALPHALONG_PARAM_IDX, "AlphaLong", 1.0, 0.1, 0.3, 5.0, errflag);
